...
const INTRINSICS: &'static [IntrinsicDefinition] = &[
    ...
    (T_INT_TY, "min", &[T_INT, T_INT], I2(Intrinsic::MinI)),
    (T_INT2_TY, "min", &[T_INT2, T_INT2], I2(Intrinsic::MinI2)),
    (T_INT3_TY, "min", &[T_INT3, T_INT3], I2(Intrinsic::MinI3)),
    (T_INT4_TY, "min", &[T_INT4, T_INT4], I2(Intrinsic::MinI4)),
    (T_FLOAT_TY, "min", &[T_FLOAT, T_FLOAT], I2(Intrinsic::MinF)),
    (T_FLOAT2_TY, "min", &[T_FLOAT2, T_FLOAT2], I2(Intrinsic::MinF2)),
    (T_FLOAT3_TY, "min", &[T_FLOAT3, T_FLOAT3], I2(Intrinsic::MinF3)),
    (T_FLOAT4_TY, "min", &[T_FLOAT4, T_FLOAT4], I2(Intrinsic::MinF4)),

    (T_INT_TY, "max", &[T_INT, T_INT], I2(Intrinsic::MaxI)),
    (T_INT2_TY, "max", &[T_INT2, T_INT2], I2(Intrinsic::MaxI2)),
    (T_INT3_TY, "max", &[T_INT3, T_INT3], I2(Intrinsic::MaxI3)),
    (T_INT4_TY, "max", &[T_INT4, T_INT4], I2(Intrinsic::MaxI4)),
    (T_FLOAT_TY, "max", &[T_FLOAT, T_FLOAT], I2(Intrinsic::MaxF)),
    (T_FLOAT2_TY, "max", &[T_FLOAT2, T_FLOAT2], I2(Intrinsic::MaxF2)),
    (T_FLOAT3_TY, "max", &[T_FLOAT3, T_FLOAT3], I2(Intrinsic::MaxF3)),
    (T_FLOAT4_TY, "max", &[T_FLOAT4, T_FLOAT4], I2(Intrinsic::MaxF4)),
